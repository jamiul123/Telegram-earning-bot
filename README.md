...
<body>
    ...
    <script src='//libtl.com/sdk.js' data-zone='10132229' data-sdk='show_10132229'></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            watchAdBtn.addEventListener('click', () => {
                ...
                // ======================================================================
                // Monetag Rewarded Popup কোড: show_10132229('pop').then(...)
                // ======================================================================
                if (typeof show_10132229 === 'function') {
                    show_10132229('pop').then(() => {
                        ...
                        // বিজ্ঞাপন শেষ হওয়ার পর বাটনটি আবার এনাবেল করা হয়েছে
                    ...
                    watchAdBtn.disabled = false; // নিশ্চিত করা হলো যেন বাটনটি এনাবেল হয়
                    updateUI();
                }
            });
